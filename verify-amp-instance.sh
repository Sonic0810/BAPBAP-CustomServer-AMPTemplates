...
EXPECTED_MOD_DLL_SHA="${EXPECTED_MOD_DLL_SHA:-035F05098CD3A413B79A51530099D5C68754A28256C5AA09C50994CE0DEF40A5}"
...
contains_text "./start-match.sh" "graphicsMode="
contains_text "./start-match.sh" "BAPCUSTOM_UNITY_GRAPHICS_MODE"
